...
static void * fn_mouline (void * p_data)
{
   while (1)
   {
	printf("mouline\n");
...
int main (void)
{
   ...
   printf ("Creation du thread mouline !\n");
   ret = pthread_create (
      & store.thread_mouline, NULL,
      fn_mouline, NULL
   );
   ...
   pthread_join (store.thread_mouline, NULL);
